...
export function getMockDashboardData(
  ...
  return {
    ...
    activityLog: [
      {
        id: "a1",
        timestamp: "2026-06-28 21:14",
        ref: "Lead #147",
        event: "lead_contacted",
        channel: "SMS",
        detail: "After-hours Meta Ads inquiry auto-replied in 38s",
      },
      {
        id: "a2",
        timestamp: "2026-06-28 09:02",
        ref: "K.L. · Botox",
        event: "reminder_sent",
        channel: "SMS",
        detail: "Morning-of confirmation for high-risk appointment",
      },
      {
        id: "a3",
        timestamp: "2026-06-27 16:40",
        ref: "Campaign · Botox Day 75",
        event: "reactivation_booked",
        channel: "Email",
        detail: "Patient booked from recall sequence · $285",
      },
      {
        id: "a4",
        timestamp: "2026-06-27 14:18",
        ref: "S.K. · Botox",
        event: "review_requested",
        channel: "SMS",
        detail: "Post-visit Google review request sent (completed appt)",
      },
      {
        id: "a5",
        ...
        event: "lead_booked",
        channel: "Web",
        detail: "Web form lead booked HydraFacial within 6 minutes",
      },
      {
        id: "a6",
        timestamp: "2026-06-25 18:22",
        ref: "M.R. · CoolSculpting",
        event: "no_show_risk_flagged",
        channel: "System",
        detail: "Previous no-show + no confirmation reply",
      },
      {
        id: "a7",
        timestamp: "2026-06-24 10:11",
        ref: "Win-back 60 Day",
        event: "campaign_sent",
        channel: "Email",
        detail: "52 lapsed patients messaged",
      },
      {
        id: "a8",
        timestamp: "2026-06-23 15:47",
        ref: "J.A. · Laser",
        event: "review_received",
        channel: "Google",
        detail: "5★ review attributed to automated request",
      },
    ],
